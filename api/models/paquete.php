...
public $desti;
  ...
  public function __construct($db) {
   ...
   public function read() {
    // Create query
    $query = 'SELECT cod_paquete, descrip, dir_destino FROM paquete, detalle_paquete, situacion WHERE cod_paquete=cod_paque and paquete.situacion=situacion.id and paquete.situacion=1';
