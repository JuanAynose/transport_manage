...
<g>
        ...
        <div class="empleado-container_footer">
            <p class="empleado-container__item__text">
                <span class="empleado-container__item__text empleado-container__item__text__color--violet">Id empleado:</span><span>${id_empleado}</span>
            </p>
            <p class="empleado-container__item__text">
...
export default CardEmployeEdit;
